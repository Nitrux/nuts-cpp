...
checkinstall -D -y \
	...
	--provides=nuts \
	--requires="libc6,libqt6core6,libqt6dbus6,libqt6quick6,libqt6qml6,libkf6coreaddons6,libkf6i18n6,libkf6notifications6,mauikit \(\>= 4.0.2\),polkitd,xfsdump,zstd,axel,wget,overlayroot" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
